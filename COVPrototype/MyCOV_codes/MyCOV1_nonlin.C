...
void MyCOV1_nonlin(TString FileName="../nucleus_shared/COVProto/2021_05_12_17_27_27/Logged Data_2021_05_12_17_27_27")
...
/////////////////////////////////////////////////////////////////////////////
  ...
  TString myfile_name = "2021_05_12_17_27_27_nonlin.root";

  Double_t a_COV1 =  2.3E-3; //V/keV^2
  Double_t b_COV1 =  .000947; //V/keV
  Double_t c_COV1 =  .000982; //V

  Double_t Cal2 =  .000650;
  Double_t Off2 = -.000068;
    
  Double_t CalNTD =  .000254;
    Double_t OffNTD = 0.001980;
  Double_t DTacc = 30.;
  ...
  h1_Peak1_keV = new TH1F("h1_Peak1_keV"," ",10000,0,20.);
  h1_Peak2_keV = new TH1F("h1_Peak2_keV"," ",10000,0,20.);
  ...
  h1_Peak1_100keV = new TH1F("h1_Peak1_100keV"," ",300,0,0.1);
  h1_Peak2_100keV = new TH1F("h1_Peak2_100keV"," ",300,0,0.1);
  h1_Peak1_100mV_AVG = new TH1F("h1_Peak1_100mV_AVG"," ", 300,0.,0.1);
  h1_Peak2_100mV_AVG = new TH1F("h1_Peak2_100mV_AVG"," ", 300,0.,0.1);
  h1_Peak1_100keV_AVG = new TH1F("h1_Peak1_100keV_AVG"," ",300,0,0.1);
  h1_Peak2_100keV_AVG = new TH1F("h1_Peak2_100keV_AVG"," ",300,0,0.1);
  ...
  h1_Peak1_100keV_1kHz_AVG = new TH1F("h1_Peak1_100keV_1kHz_AVG"," ",300,0,0.1);
  h1_Peak2_100keV_1kHz_AVG = new TH1F("h1_Peak2_100keV_1kHz_AVG"," ",300,0,0.1);
  ...
  h1_NTD_Amplitude_keV  = new TH1F("h1_NTD_Amplitude_keV"," ", 500,  0., 2.);
...
//
      ...
      for (int k = 0; k < NS; k++) {
        ...
        if ((k + 1)%100 == 0) {
          ...
          if (nBSL1 > 1) {
            h1_BSLM1->Fill(BSL_M1/b_COV1);
            h1_BSLS1->Fill(BSL_S1/b_COV1);
          }
...
//
      ...
      for (int k = 1; k < NS/Ndiv; k++) {
	    ...
	    for (int kk = j2 + 2; kk < j2 + 20/Ndiv + 2; kk++) {Sum3 = Sum3 + (COV1_AVG[kk] - COV1_AVG[kk - 1] - DIF1_AVG_bias[kk/(100/Ndiv)])*float(j2 - j1 + 2)/(40./float(Ndiv));}
          ...
          if (Sum_DIF1_AVG[k] > RT1_Threshold) {
...
//
     ...
     if (iw_NTD == iw_NTD_sel && Flag_NTD == false) {
	  ...
	  if ((T_NTD[ip] - T_COV2[jp] + DTacc) >= -2. && (T_NTD[ip] - T_COV2[jp] + DTacc) < 4.) {
        ...
        if (T_Closest >=  -2. && T_Closest <   4.) h1_NTD_11_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (T_Closest <   -2. || T_Closest >=  4.) h1_NTD_12_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
