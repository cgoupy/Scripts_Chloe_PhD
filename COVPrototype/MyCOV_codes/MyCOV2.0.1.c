...
void MyCOV1(TString FileName="/feynman/work/projets/cupid/data/NUCLEUS_COVProto/2021_05_12_17_27_27/LoggedData_2021_05_12_17_27_27")
...
/////////////////////////////////////////////////////////////////////////////
  ...
  TString myfile_name = "2021_05_12_17_27_27_new_nonlin.root";

// Data_2021_05_05_17_40_40
  Double_t Cal1 =  .0009536;
  Double_t Cal2 =  .0006513;
  Double_t Off1 = -.001227;
  Double_t Off2 = -.000801;
  Cal1 =  .0009522;
  Cal2 =  .0006513;
  Off1 =  .0004200;
  Off2 = -.0009625;
  Double_t CalNTD =  .0002361;
  Double_t OffNTD =  .0025166;
//
...
/////////////////////////////////////////////////////////////////////////////
  ...
  Double_t Threshold_keV_1 =  5.0;
  Double_t Threshold_keV_2 = 10.0;
  Double_t Peak1_Threshold =  5.0; 
  Double_t Peak2_Threshold = 10.0; 
  Double_t Peak1_Upper_Threshold =  7.5; 
  ...
  Double_t NTD_Threshold_Sum = NTD_Threshold_keV_Sum*CalNTD;
...
//
      ...
      for (int k = 1; k < NS; k++) {
        ...
        if (Flag_DIF1[k]) {
          ...
          Sum_DIF1[k] = Sum1 - Sum2 - Sum3 - Off1;
	  if ((Sum_DIF1[k] > Peak1_Threshold*Cal1) && ((k%100 != 2 && Sum_DIF1[k] <= Peak1_Upper_Threshold*Cal1) || Sum_DIF1[k] > Peak1_Upper_Threshold*Cal1) && Flag_Ovfl1 == false) Flag_Peak1[k] = true;
      ...
      for (int k = 1; k < NS/Ndiv; k++) {
	    ...
	    for (int kk = j2 + 2; kk < j2 + 20/Ndiv + 2; kk++) {Sum3 = Sum3 + (COV1_AVG[kk] - COV1_AVG[kk - 1] - DIF1_AVG_bias[kk/(100/Ndiv)])*float(j2 - j1 + 2)/(40./float(Ndiv));}
          ...
          Sum_DIF1_AVG[k] = Sum1 - Sum2 - Sum3 - Off1;
          if (Sum_DIF1_AVG[k] > Peak1_Threshold*Cal1 && Flag_Ovfl1_AVG == false) {
      ...
      for (int k = 1; k < NS; k++) {
        ...
        if (Flag_DIF2[k]) {
          ...
          Sum_DIF2[k] = Sum1 - Sum2 - Sum3 - Off2;
	  if ((Sum_DIF2[k] > Peak2_Threshold*Cal2) && ((k%100 != 1 && Sum_DIF2[k] <= Peak2_Upper_Threshold*Cal2) || Sum_DIF2[k] > Peak2_Upper_Threshold*Cal2) && Flag_Ovfl2 == false) Flag_Peak2[k] = true;
          if (Flag_Peak2[k]) {
	  ...
	  if (Flag_Sum3) {
          ...
          Sum_DIF2_AVG[k] = Sum1 - Sum2 - Sum3 - Off2;
          if (Sum_DIF2_AVG[k] > Peak2_Threshold*Cal2 && Flag_Ovfl2_AVG == false) {
	  ...
	  */
        ...
        if (Flag_Peak1[k] && Flag_Peak2[k]) {
          ...
          h2_Peak1_2_C_MeV->Fill(Sum_DIF1[k]/Cal1/1000., Sum_DIF2[k]/Cal2/1000.);
          if (Sum_DIF1[k]/Cal1/1000. > 10. && Sum_DIF2[k]/Cal2/1000. > 10.) {
            h1_Peak1over2_MeV->Fill(log(Sum_DIF1[k]/Cal1) - log(Sum_DIF2[k]/Cal2));
	  }
	  /*
	  ...
	  */
      ...
      for (int k = 0; k < NS/Ndiv; k++) {
        ...
        if (Flag_Peak1_AVG[k] && Flag_Peak2_AVG[k]) {
          ...
          h1_Peak1_C_4MeV_AVG->Fill(Sum_DIF1_AVG[k]/Cal1/1000.);
          h1_Peak2_C_4MeV_AVG->Fill(Sum_DIF2_AVG[k]/Cal2/1000.);
          h2_Peak1_2_C_MeV_AVG->Fill(Sum_DIF1_AVG[k]/Cal1/1000., Sum_DIF2_AVG[k]/Cal2/1000.);
          if (Sum_DIF1_AVG[k]/Cal1/1000. > 10. && Sum_DIF2_AVG[k]/Cal2/1000. > 10.) {
            h1_Peak1over2_MeV_AVG->Fill(log(Sum_DIF1_AVG[k]/Cal1) - log(Sum_DIF2_AVG[k]/Cal2));
	  }
    ...
    if (i_NTD == NS_NTD) {
      ...
      for (int k = 1; k < NS_NTD/FRed; k++) {
        ...
        if ((k + 1)%100 == 0) {
          ...
          //cout << " BSL" << nBSL_NTD << " " << BSL_NTD_S/CalNTD << " " << endl;
//
          nBSL_NTD = 0;
          BSL_NTD_M = 0.;
          BSL_NTD_S = 0.;
     ...
     if (iw_NTD == iw_NTD_sel && Flag_NTD == false) {
      ...
      for (int ip = 0; ip < ip_NTD; ip++) {
        ...
        Double_t DT1, DT2;
        h1_NTD_Amplitude_MeV->Fill(P_NTD[ip]/CalNTD/1000.);
	  ...
	  if ((T_NTD[ip] - T_COV2[jp] + DTacc) >= -2. && (T_NTD[ip] - T_COV2[jp] + DTacc) < 3.) {
        ...
        if (T_Closest >=  -2. && T_Closest <   3.) h1_NTD_11_MeV->Fill(P_NTD[ip]/CalNTD/1000.);
        if (T_Closest <   -4. || T_Closest >=  5.) h1_NTD_12_MeV->Fill(P_NTD[ip]/CalNTD/1000.);      
