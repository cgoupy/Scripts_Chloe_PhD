...
using namespace std;
double Racine(Double_t x, Double_t a, Double_t b, Double_t c){
    if (x>c){
            Double_t rac1 = (-b+sqrt(b*b-4*a*(c-x)))/(2*a);
            Double_t rac2 = (-b-sqrt(b*b-4*a*(c-x)))/(2*a);

            if ((rac1<0)&&(rac2>=0)) return rac2;
            else if ((rac2<0)&&(rac1>=0)) return rac1;
            else if ((rac2<0)&&(rac1<0)) {
                cout<<"WARNING: roots < 0"<<endl;
                return -999999;
            }
            else {
                cout<<"WARNING: don't know what is the correct root between "<<rac1<<" and "<<rac2<<endl;
                cout<<x<<endl;
                cout<<sqrt(b*b-4*a*(c-x))<<endl;
                return -999999;
            }
        }
        else {
            ...
            if ((rac1<=0)&&(rac2>0)) return rac1;
            else if ((rac2<=0)&&(rac1>0)) return rac2;
            else if ((rac2>0)&&(rac1>0)) {
                cout<<"WARNING: roots > 0"<<endl;
                return -999999;
            }
...
double Pol2(Double_t x, Double_t a, Double_t b, Double_t c){
    return a*x*x+b*x+c;
}
...
void MyCOV1_nonlin(TString FileName="/feynman/work/projets/cupid/data/NUCLEUS_COVProto/2021_05_12_17_27_27/LoggedData_2021_05_12_17_27_27")
...
/////////////////////////////////////////////////////////////////////////////
  ...
  TString myfile_name = "2021_05_12_17_27_27__new_nonlin.root";
  Double_t a_COV1 =  1.4E-9; //V/keV^2
  Double_t b_COV1 =  .0009499; //V/keV
  Double_t c_COV1 =  .0000962; //V

  Double_t Cal2 =  .0006515;
  Double_t Off2 = -.0000217;

  Double_t CalNTD =  .0002417;
  Double_t OffNTD = -.0002204;
  Double_t DTacc = 30.;
  ...
  Int_t N_OVL = 5;
  Double_t E_OVL[5] = {  30.,  30.,  30.,  30.,  30.};
  ...
  TH1F *h1_Peak1, *h1_Peak2, *h1_Peak1_MeV, *h1_Peak2_MeV, *h1_Peak1_4MeV, *h1_Peak2_4MeV;
  ...
  TH1F *h1_RunTime = new TH1F("h1_RunTime"," ",1,0.,1.);
  TH1F *h1_Thresholds = new TH1F("h1_Thresholds"," ",4,0.,4.);
  TH1F *h1_Gains = new TH1F("h1_Gains"," ",3,0.,3.);
  TH1F *h1_E_OVL = new TH1F("h1_E_OVL"," ",200,0.,200.);  
  TH1F *h1_COV1_OVL = new TH1F("h1_COV1_OVL"," ",400,0.,200.);
  TH1F *h1_COV2_OVL = new TH1F("h1_COV2_OVL"," ",400,0.,200.);
  TH1F *h1_DeltaT_Closest = new TH1F("h1_DeltaT_Closest"," ",2000,-50., 50.);
  ...
  TH1F *h1_Raw1 = new TH1F("h1_Raw1"," ",100000,0.,100000.);
  TH1F *h1_Raw2 = new TH1F("h1_Raw2"," ",100000,0.,100000.);
  TH1F *h1_Raw3 = new TH1F("h1_Raw3"," ",100000,0.,100000.);
  TH1F *h1_Raw4 = new TH1F("h1_Raw4"," ",100000,0.,100000.);
  TH1F *h1_Raw5 = new TH1F("h1_Raw5"," ",100000,0.,100000.);
  TH1F *h1_COV1 = new TH1F("h1_COV1"," ",100000,0.,100000.);
  TH1F *h1_COV2 = new TH1F("h1_COV2"," ",100000,0.,100000.);
  TH1F *h1_DIF1 = new TH1F("h1_DIF1"," ",100000,0.,100000.);
  TH1F *h1_DIF2 = new TH1F("h1_DIF2"," ",100000,0.,100000.);
  ...
  h1_Peak1_keV = new TH1F("h1_Peak1_keV"," ",10000,c_COV1,20./b_COV1);
  ...
  h1_Peak1_C_250keV = new TH1F("h1_Peak1_C_250keV"," ",250,0.,250.);
  h1_Peak2_C_250keV = new TH1F("h1_Peak2_C_250keV"," ",250,0.,250.);
  h1_Peak1_MeV = new TH1F("h1_Peak1_MeV"," ",4000,0.,20.);
  h1_Peak2_MeV = new TH1F("h1_Peak2_MeV"," ",4000,0.,20.);
  h1_Peak1_4MeV = new TH1F("h1_Peak1_4MeV"," ",2000,0.,4.);
  h1_Peak2_4MeV = new TH1F("h1_Peak2_4MeV"," ",2000,0.,4.);
  h1_Peak1_C_MeV = new TH1F("h1_Peak1_C_MeV"," ",4000,0.,20.);
  h1_Peak2_C_MeV = new TH1F("h1_Peak2_C_MeV"," ",4000,0.,20.);
  h1_Peak1_100mV = new TH1F("h1_Peak1_100mV"," ", 300,0.,0.1);
  h1_Peak2_100mV = new TH1F("h1_Peak2_100mV"," ", 300,0.,0.1);
  h1_Peak1_100keV = new TH1F("h1_Peak1_100keV"," ",300,c_COV1,0.1/b_COV1);
  ...
  h1_Peak1_100keV_AVG = new TH1F("h1_Peak1_100keV_AVG"," ",300,c_COV1,0.1/b_COV1);
  h1_Peak2_100keV_AVG = new TH1F("h1_Peak2_100keV_AVG"," ",300,Off2,0.1/Cal2);
  ...
  h1_Peak1_100keV_1kHz_AVG = new TH1F("h1_Peak1_100keV_1kHz_AVG"," ",300,c_COV1,0.1/b_COV1);
  h1_Peak2_100keV_1kHz_AVG = new TH1F("h1_Peak2_100keV_1kHz_AVG"," ",300,Off2,0.1/Cal2);
  TH1F *h1_Peak1_MeV_AVG = new TH1F("h1_Peak1_MeV_AVG"," ",4000,0.,20.);
  TH1F *h1_Peak2_MeV_AVG = new TH1F("h1_Peak2_MeV_AVG"," ",4000,0.,20.);
  TH1F *h1_Peak1_4MeV_AVG = new TH1F("h1_Peak1_4MeV_AVG"," ",4000,0.,4.);
  TH1F *h1_Peak2_4MeV_AVG = new TH1F("h1_Peak2_4MeV_AVG"," ",4000,0.,4.);
  TH1F *h1_Peak1_C_MeV_AVG = new TH1F("h1_Peak1_C_MeV_AVG"," ",4000,0.,20.);
  TH1F *h1_Peak2_C_MeV_AVG = new TH1F("h1_Peak2_C_MeV_AVG"," ",4000,0.,20.);
  TH1F *h1_Peak1_C_4MeV_AVG = new TH1F("h1_Peak1_C_4MeV_AVG"," ",4000,0.,4.);
  TH1F *h1_Peak2_C_4MeV_AVG = new TH1F("h1_Peak2_C_4MeV_AVG"," ",4000,0.,4.);
  TH2F *h2_Peak1_2_C_MeV     = new TH2F("h2_Peak1_2_C_MeV",    " ",50, 0., 25.,50, 0., 25.);
  TH2F *h2_Peak1_2_C_MeV_AVG = new TH2F("h2_Peak1_2_C_MeV_AVG"," ",50, 0., 25.,50, 0., 25.);
  TH1F *h1_Peak1over2_MeV     = new TH1F("h1_Peak1over2_MeV",    " ",50,-1.,1.);
  TH1F *h1_Peak1over2_MeV_AVG = new TH1F("h1_Peak1over2_MeV_AVG"," ",50,-1.,1.);
  //  h1_Peak1_4MeV_AVG = new TH1F("h1_Peak1_4MeV_AVG"," ",4000,0.,4.);
  //  h1_Peak2_4MeV_AVG = new TH1F("h1_Peak2_4MeV_AVG"," ",4000,0.,4.);
  h1_Peak1_200keV_AVG = new TH1F("h1_Peak1_200keV_AVG"," ",400,0.,200.);
  h1_Peak2_200keV_AVG = new TH1F("h1_Peak2_200keV_AVG"," ",400,0.,200.);
  TH1F *h1_Width1 = new TH1F("h1_Width1"," ",20,0.,20.);
  TH1F *h1_Width2 = new TH1F("h1_Width2"," ",20,0.,20.);
  TH1F *h1_Width1_AVG = new TH1F("h1_Width1_AVG"," ",20,0.,20.);
  TH1F *h1_Width2_AVG = new TH1F("h1_Width2_AVG"," ",20,0.,20.);
  ...
  h1_BSL_NTD_M = new TH1F("h1_BSL_NTD_M"," ",  400,-4.0,4.0);
  h1_BSL_NTD_S = new TH1F("h1_BSL_NTD_S"," ",  200, 0.,20.0);
  ...
  Int_t Nbins_NTD_A = 2000;
  Double_t A_MX_NTD = 2.0;
  TH1F *h1_NTD_Amplitude      = new TH1F("h1_NTD_Amplitude"    ," ",Nbins_NTD_A,      0.,        A_MX_NTD);
  TH1F *h1_NTD_Amplitude_keV  = new TH1F("h1_NTD_Amplitude_keV"," ",Nbins_NTD_A,  OffNTD, A_MX_NTD/CalNTD);
  TH1F *h1_NTD_Amplitude_MeV  = new TH1F("h1_NTD_Amplitude_MeV"," ",2500,  0., 10.);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  Double_t E1, E2, E1_AVG, E2_AVG, D1, D2;
  ...
  unsigned iw_NTD_sel = 10;
  Bool_t Flag_NTD = false;
...
// Read Ge detector data
    ...
    ifstream rf1(FileName+".Bin1", ios::in | ios::binary);
    if (!rf1) {cout << "Cannot open input file 1!" << endl;}

    ifstream rf2(FileName+".Bin2", ios::in | ios::binary);
    if (!rf2) {cout << "Cannot open input file 2!" << endl;}

    ifstream rf3(FileName+".Bin3", ios::in | ios::binary);
    if (!rf3) {cout << "Cannot open input file 3!" << endl;}

    ifstream rf4(FileName+".Bin4", ios::in | ios::binary);
    if (!rf4) {cout << "Cannot open input file 4!" << endl;}

    ifstream rf5(FileName+".NTD", ios::in | ios::binary);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  Int_t Ovfl1[100000], Ovfl2[100000], Ovfl1_AVG[50000], Ovfl2_AVG[50000];
  ...
  Double_t NTD_Threshold_keV_Sum = 25.0;
  Double_t NTD_Threshold_Sum = NTD_Threshold_keV_Sum*CalNTD+OffNTD;
  //  Double_t NTD_Threshold = 0.0060;
  Double_t NTD_Threshold = NTD_Threshold_keV*CalNTD+OffNTD;
  ...
  h1_Thresholds->SetBinContent(4,NTD_Threshold_keV_Sum);
  ...
  RT1_Threshold = a_COV1*Threshold_keV_1*Threshold_keV_1+b_COV1*Threshold_keV_1+c_COV1;
  RT2_Threshold = Threshold_keV_2*Cal2+Off2;
  ...
  Int_t N_Seconds = 43200;
  while (!rf1.eof() && !rf2.eof() && !rf3.eof() && !rf4.eof() && !rf5.eof()) {
  //while (!rf1.eof() && !rf2.eof() && !rf3.eof() && !rf4.eof() && !rf5.eof() && nw1/NS + nw2/NS < N_Seconds) {
    Ovfl1[i] = 0;
    Ovfl2[i] = 0;
    ...
    if (i < NS) {
      Raw2[i] = ampl;
      if (Raw2[i] == 32767.) Ovfl1[i] = Ovfl1[i] + 2;  
    ...
    if (i < NS) { 
      Raw4[i] = ampl;
      if (Raw4[i] == 32767.) Ovfl2[i] = Ovfl2[i] + 2;  
...
// 
    ...
    if (i == NS) {  
	  ...
	  COV1_AVG[ii] = COV1_AVG[ii] + COV1[2*ii + idiv]/float(Ndiv);
          if (Ovfl1[2*ii + idiv] > 0) Ovfl1_AVG[ii] = 1;
        }
        COV2_AVG[ii] = 0.;
        Ovfl2_AVG[ii] = 0;
        for (int idiv = 0; idiv < Ndiv; idiv++) {
	  COV2_AVG[ii] = COV2_AVG[ii] + COV2[2*ii + idiv]/float(Ndiv);
          if (Ovfl2[2*ii + idiv] > 0) Ovfl2_AVG[ii] = 1;
        }
      }
...
//
      ...
      for (int k = 0; k < NS; k++) {
        ...
        if ((k + 1)%100 == 0) {
          ...
          if (nBSL1 > 1) {
            h1_BSLM1->Fill(Racine(BSL_M1, a_COV1, b_COV1, c_COV1));
            h1_BSLS1->Fill(Racine(BSL_S1, a_COV1, b_COV1, c_COV1));
          }
...
//
          ...
          if (nBSL2 > 1) {
            h1_BSLM2->Fill((BSL_M2-Off2)/Cal2);
            h1_BSLS2->Fill((BSL_S2-Off2)/Cal2);
          }
...
//
      ...
      for (int k = 0; k < NS/Ndiv; k++) {
        ...
        if ((k + 1)%(100/Ndiv) == 0) {
          ...
          if (nBSL1_AVG > 1) {
            h1_BSLM1_AVG->Fill(Racine(BSL_M1_AVG, a_COV1, b_COV1, c_COV1));
            h1_BSLS1_AVG->Fill(Racine(BSL_S1_AVG, a_COV1, b_COV1, c_COV1));
            h1_BslM1_AVG[inw]->Fill(Racine(BSL_M1_AVG, a_COV1, b_COV1, c_COV1));
            h1_BslS1_AVG[inw]->Fill(Racine(BSL_S1_AVG, a_COV1, b_COV1, c_COV1));
 
          }
          DIF1_AVG_bias[k/(100/Ndiv)] = BSL_M1_AVG;
          DIF1_AVG_bias[k/(100/Ndiv)] = 0.;
//
          nBSL1_AVG = 0;
          BSL_M1_AVG = 0.;
          BSL_S1_AVG = 0.;
//
          ...
          if (nBSL2_AVG > 1) {
            h1_BSLM2_AVG->Fill((BSL_M2_AVG-Off2)/Cal2);
            h1_BSLS2_AVG->Fill((BSL_S2_AVG-Off2)/Cal2);
            h1_BslM2_AVG[inw]->Fill((BSL_M2_AVG-Off2)/Cal2);
            h1_BslS2_AVG[inw]->Fill((BSL_S2_AVG-Off2)/Cal2);
          }
          DIF2_AVG_bias[k/(100/Ndiv)] = BSL_M2_AVG;
          DIF2_AVG_bias[k/(100/Ndiv)] = 0.;
...
//
      ...
      for (int k = 1; k < NS; k++) {
        ...
        if (Flag_DIF1[k]) {
          ...
          Bool_t Flag_Ovfl1 = false;
          for (int kk = j1 - 1; kk < j2 + 1; kk++) {if (Ovfl1[kk] > 0) Flag_Ovfl1 = true;}
          Sum1 = 0.;
          ...
          if (nbsl > 1) {
            h1_bsl_M1->Fill(Racine(bsl_M, a_COV1, b_COV1, c_COV1));
            h1_bsl_S1->Fill(Racine(bsl_S, a_COV1, b_COV1, c_COV1));
          }          
          Sum_DIF1[k] = Sum1 - Sum2 - Sum3;
            if ((Sum_DIF1[k] > Pol2(Peak1_Threshold, a_COV1, b_COV1, c_COV1)) && ((k%100 != 2 && Sum_DIF1[k] <= Pol2(Peak1_Upper_Threshold, a_COV1, b_COV1, c_COV1)) || Sum_DIF1[k] > Pol2(Peak1_Upper_Threshold,a_COV1, b_COV1, c_COV1))) Flag_Peak1[k] = true;

          if (Flag_Peak1[k]) {
            h1_Width1->Fill(float(j2) - float(j1));
            Int_t ll0 = j1;
	    Double_t sl_max = -99999.;
          ...
          if (Flag_Overlay && Flag_Peak1[k]) {
            dkt1_after = k - kt1;
            if (dkt1_after > 17500 && dkt1_before > 17500 && Racine(Sum_DIF1[kt1], a_COV1, b_COV1, c_COV1) > 150. && Racine(Sum_DIF1[kt1], a_COV1, b_COV1, c_COV1) < 2000.) {
              nov1++;
              cout << " Overlay 1 !!! << " << nov1 << " " << iw << " " << kt1 << " " << dkt1_before << " " << dkt1_after << " " << Racine(Sum_DIF1[kt1], a_COV1, b_COV1, c_COV1) << " " << Raw1[kt1] << " " << Raw2[kt1] << " " << endl;
              for (int kk = kt1 - 1; kk < kt1 + 5000 - 1; kk++) {
                Int_t kk0 = kt1 - 1;
                Raw1_Overlay[kk - kk0] = Raw1_Overlay[kk - kk0] + Pol2((Raw1[kk] - Raw1[kt1 - 1]),a_COV1, b_COV1, c_COV1)/Sum_DIF1[kt1];
                Raw2_Overlay[kk - kk0] = Raw2_Overlay[kk - kk0] + Pol2((Raw2[kk] - Raw2[kt1 - 1]), a_COV1, b_COV1, c_COV1)/Sum_DIF1[kt1];
              }
            }
            kt1 = k;
      ...
      for (int k = 1; k < NS/Ndiv; k++) {
        ...
        if (Flag_DIF1_AVG[k]) {
          ...
          Bool_t Flag_Ovfl1_AVG = false; 
          for (int kk = j1 - 1; kk < j2 + 1; kk++) {if (Ovfl1_AVG[kk] > 0) Flag_Ovfl1_AVG = true;}
          Sum1 = 0.;
	    ...
	    for (int kk = j2 + 2; kk < j2 + 20/Ndiv + 2; kk++) {Sum3 = Sum3 + (COV1_AVG[kk] - COV1_AVG[kk - 1] - DIF1_AVG_bias[kk/(100/Ndiv)])*float(j2 - j1 + 2)/(40./float(Ndiv));}
          ...
          if (Sum_DIF1_AVG[k] > RT1_Threshold  && Flag_Ovfl1_AVG == false) {
            if ((k%50 != Tbin_1kHz_1 && Sum_DIF1_AVG[k] <= Pol2(Peak1_Upper_Threshold,a_COV1, b_COV1, c_COV1)) || Sum_DIF1_AVG[k] > Pol2(Peak1_Upper_Threshold,a_COV1, b_COV1, c_COV1)) Flag_Peak1_AVG[k] = true;
            if (k%50 == Tbin_1kHz_1 && Sum_DIF1_AVG[k] <= Pol2(Peak1_Upper_Threshold, a_COV1, b_COV1, c_COV1)) Flag_Peak1_1kHz_AVG[k] = true;
          }
          if (Flag_Peak1_AVG[k] == true) {
            h1_Width1_AVG->Fill(float(j2) - float(j1));
          }
          //if (Flag_Peak1_AVG[k] == true)       }
      ...
      for (int k = 1; k < NS; k++) {
        ...
        if (Flag_DIF2[k]) {
          ...
          Bool_t Flag_Ovfl2 = false;
          for (int kk = j1 - 1; kk < j2 + 1; kk++) {if (Ovfl2[kk] > 0) Flag_Ovfl2 = true;}
          Sum1 = 0.;
          ...
          bsl_S = sqrt(bsl_S/max(1,nbsl) - bsl_M*bsl_M);
          if (nbsl > 1) {
            h1_bsl_M2->Fill((bsl_M-Off2)/Cal2);
            h1_bsl_S2->Fill((bsl_S-Off2)/Cal2);
          }          
          Sum_DIF2[k] = Sum1 - Sum2 - Sum3;
	  if ((Sum_DIF2[k] > Peak2_Threshold*Cal2+Off2) && ((k%100 != 1 && Sum_DIF2[k] <= Peak2_Upper_Threshold*Cal2+Off2) || Sum_DIF2[k] > Peak2_Upper_Threshold*Cal2+Off2)) Flag_Peak2[k] = true;
            if (Flag_Peak2[k]) {
                h1_Width2->Fill(float(j2) - float(j1));
            }
            //if (Flag_Peak2[k] == true) cout << " dj ok " << j2 - j1 + 1 << " " << Sum_DIF2[k]/Cal2 << " " << endl;

          if (Flag_Overlay && Flag_Peak2[k]) {
            dkt2_after = k - kt2;
            if (dkt2_after > 30000 && dkt2_before > 30000 && (Sum_DIF2[kt2]-Off2)/Cal2 > 150. && (Sum_DIF2[kt2]-Off2)/Cal2 < 2000.) {
              nov2++;
              cout << " Overlay 2 !!! << " << nov2 << " " << iw << " " << kt2 << " " << " " << dkt2_before << " " << dkt2_after << " " << (Sum_DIF2[kt2]-Off2)/Cal2 << " " << Raw3[kt2] << " " << Raw4[kt2] << " " << endl;
              for (int kk = kt2 - 1; kk < kt2 + 5000 - 1; kk++) {
                Int_t kk0 = kt2 - 1;
                Raw3_Overlay[kk - kk0] = Raw3_Overlay[kk - kk0] + (Cal2*(Raw3[kk] - Raw3[kt2 - 1])+Off2)/Sum_DIF2[kt2];
                Raw4_Overlay[kk - kk0] = Raw4_Overlay[kk - kk0] + (Cal2*(Raw4[kk] - Raw4[kt2 - 1])+Off2)/Sum_DIF2[kt2];
              }
            }
            kt2 = k;
      ...
      for (int k = 1; k < NS/Ndiv; k++) {
        ...
        if (Flag_DIF2_AVG[k]) {
          ...
          Bool_t Flag_Ovfl2_AVG = false; 
          for (int kk = j1 - 1; kk < j2 + 1; kk++) {if (Ovfl2_AVG[kk] > 0) Flag_Ovfl2_AVG = true;}
          Sum1 = 0.;
	  ...
	  if (Flag_Sum3) {
          ...
          if (Sum_DIF2_AVG[k] > Peak2_Threshold*Cal2+Off2) {
            if ((k%50 != Tbin_1kHz_2 && Sum_DIF2_AVG[k] <= Peak2_Upper_Threshold*Cal2+Off2) || Sum_DIF2_AVG[k] > Peak2_Upper_Threshold*Cal2+Off2) Flag_Peak2_AVG[k] = true;
            if (k%50 == Tbin_1kHz_2 && Sum_DIF2_AVG[k] <= Peak2_Upper_Threshold*Cal2+Off2) Flag_Peak2_1kHz_AVG[k] = true;
          }
          if (Flag_Peak2_AVG[k] == true) {
            h1_Width2_AVG->Fill(float(j2) - float(j1));
          }
      ...
      for (int k = 0; k < NS; k++) {
        ...
        if (Flag_Peak1[k]) {
          Int_t iww1 = 10000 + iw%100;
	  if (k == iww1 + 1) h1_COV1_OVL->Fill(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1));
          if (nt1 < 10000) {
          ...
          h1_Peak1_Am241_AVG[inw]->Fill(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1));
          h1_Peak1_MeV->Fill(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1)/1000.);
          h1_Peak1_4MeV->Fill(Racine(Sum_DIF1[k],a_COV1, b_COV1, c_COV1)/1000.);
	  /*
	  ...
	  */
        ...
        if (Flag_Peak2[k]) {
          Int_t iww1 = 10000 + iw%100;
	  if (k == iww1 + 1) h1_COV2_OVL->Fill((Sum_DIF2[k]-Off2)/Cal2);
          if (nt2 < 10000) {
          ...
          h1_Peak2_MeV->Fill((Sum_DIF2[k]-Off2)/Cal2/1000.);
          h1_Peak2_4MeV->Fill((Sum_DIF2[k]-Off2)/Cal2/1000.);
	  /*
	  ...
	  */
        ...
        if (Flag_Peak1[k] && Flag_Peak2[k]) {
          h1_Peak1_C_keV->Fill(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1));
          h1_Peak2_C_keV->Fill((Sum_DIF2[k]-Off2)/Cal2);
          if (Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1) <= 250.) h1_Peak1_C_250keV->Fill(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1));
          if ((Sum_DIF2[k]-Off2)/Cal2 <= 250.) h1_Peak2_C_250keV->Fill((Sum_DIF2[k]-Off2)/Cal2);
          h1_Peak1_C_MeV->Fill(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1)/1000.);
          h1_Peak2_C_MeV->Fill((Sum_DIF2[k]-Off2)/Cal2/1000.);
            if (Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1)/1000. > 10. && (Sum_DIF2[k]-Off2)/Cal2/1000. > 10.) {
                h1_Peak1over2_MeV->Fill(log(Racine(Sum_DIF1[k], a_COV1, b_COV1, c_COV1)) - log((Sum_DIF2[k]-Off2)/Cal2));
            }
	  /*
	  ...
	  */
      ...
      for (int k = 0; k < NS/Ndiv; k++) {
        ...
        if (Flag_Peak1_AVG[k]) {
          ...
          P_COV1[ip1_ms] = Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1);
          np1++;
          ip1_ms++;
        }
        if (Flag_Peak2_AVG[k]) {
          T_COV2[ip2_ms] = 1000.*(iw%FRed) + float(Ndiv)*float(k)/100.;
          P_COV2[ip2_ms] = (Sum_DIF2_AVG[k]-Off2)/Cal2;
          np2++;
          ip2_ms++;
        }
        if (Flag_Peak1_AVG[k] && Flag_Peak2_AVG[k]) {
          h1_Peak1_C_MeV_AVG->Fill(Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)/1000.);
          h1_Peak2_C_MeV_AVG->Fill((Sum_DIF2_AVG[k]-Off2)/Cal2/1000.);
          h1_Peak1_C_4MeV_AVG->Fill(Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)/1000.);
          h1_Peak2_C_4MeV_AVG->Fill((Sum_DIF2_AVG[k]-Off2)/Cal2/1000.);
          h2_Peak1_2_C_MeV_AVG->Fill(Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)/1000., (Sum_DIF2_AVG[k]-Off2)/Cal2/1000.);
          if (Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)/1000. > 10. && (Sum_DIF2_AVG[k]-Off2)/Cal2/1000. > 10.) {
            h1_Peak1over2_MeV_AVG->Fill(log(Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)) - log((Sum_DIF2_AVG[k]-Off2)/Cal2));
	  }
        ...
        if (Flag_Peak1_AVG[k]) {h1_Peak1_MeV_AVG->Fill(Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)/1000.);}
        if (Flag_Peak2_AVG[k]) {h1_Peak2_MeV_AVG->Fill((Sum_DIF2_AVG[k]-Off2)/Cal2/1000.);}
        if (Flag_Peak1_AVG[k]) {h1_Peak1_4MeV_AVG->Fill(Racine(Sum_DIF1_AVG[k], a_COV1, b_COV1, c_COV1)/1000.);}
        if (Flag_Peak2_AVG[k]) {h1_Peak2_4MeV_AVG->Fill((Sum_DIF2_AVG[k]-Off2)/Cal2/1000.);}
        ...
        if (Flag_Peak1_AVG[k]) {h1_Peak1_200keV_AVG->Fill(Racine(Sum_DIF1_AVG[k],a_COV1, b_COV1, c_COV1));}
        if (Flag_Peak2_AVG[k]) {h1_Peak2_200keV_AVG->Fill((Sum_DIF2_AVG[k]-Off2)/Cal2);}
      }
    ...
    if (i_NTD == NS_NTD) {
      ...
      for (int k = 1; k < NS_NTD/FRed; k++) {
        ...
        if (abs(DIF_NTD) < 0.8*NTD_Threshold) {
        ...
        if ((k + 1)%100 == 0) {
          ...
          if (nBSL_NTD > 80) {
            h1_BSL_NTD_M->Fill((BSL_NTD_M-OffNTD)/CalNTD);
            h1_BSL_NTD_S->Fill((BSL_NTD_S-OffNTD)/CalNTD);
          }
//
          nBSL_NTD = 0;
          BSL_NTD_M = 0.;
      ...
      for (int k = 1; k < NS_NTD/FRed; k++) {
        if (k > k_max) { 
          ...
          if (DIF_NTD > 0.) {
            ...
            Sum2 = 0.;
            for (int kk = k_min - 11; kk < k_min - 1; kk++) {
              Sum2 = Sum2 + (NTD[kk - 1] - NTD[kk])*float(k_max - k_min)/10.;
            }
            Int_t ie = (nw1/NS + nw2/NS)/720;
            if (k_max - k_min > 3 && k_max < 99990 && NTD[k_min] - NTD[k_max] - Sum2 > NTD_Threshold_Sum) {
              if (k_min > 99980) cout << " WARNING !!! " << k_min << " " << k_max << " " << iw_NTD << " " << NTD[k_min] - NTD[k_max] << " " << endl; 
              h1_T_NTD->Fill(float(k_max));
              h1_NTD_Amplitude->Fill(NTD[k_min] - NTD[k_max] - Sum2);
            }
            if (NTD[k_min] - NTD[k_max] - Sum2 > NTD_Threshold_Sum) h2_Width_Amplitude->Fill(float(k_max - k_min),NTD[k_min] - NTD[k_max] - Sum2);
            if (k_max - k_min > 3 && k_max < 99980 && NTD[k_min] - NTD[k_max] - Sum2 > NTD_Threshold_Sum + OffNTD) {
              //T_NTD[ip_NTD] = iw_NTD*NS + k_min;
              Int_t ie = (nw1/NS + nw2/NS)/720;
              //P_NTD[ip_NTD] = (NTD[k_min] - NTD[k_max])*(1. - .01893*BSL_NTD_RAW[ie]);
              P_NTD[ip_NTD] = NTD[k_min] - NTD[k_max] - Sum2 - OffNTD;
	      ...
	      Double_t sl_max = -99999.;
              ...
              T_NTD[ip_NTD] = k0*float(FRed)/float(100) - 1.000 + 0.586 + 0.344;
              //Int_t ie = (nw1/NS + nw2/NS)/720;
              if ((P_NTD[ip_NTD]-OffNTD)/CalNTD > h1_Alpha_Min && (P_NTD[ip_NTD]-OffNTD)/CalNTD < h1_Alpha_Max) {
                h1_Alpha[ie]->Fill((P_NTD[ip_NTD]-OffNTD)/CalNTD);
                h2_BSLM_E_Alpha->Fill(BSL_NTD_RAW[ie],(P_NTD[ip_NTD]-OffNTD)/CalNTD);
              }
              ip_NTD++;
              np_NTD++;
            }
     ...
     if (iw_NTD == iw_NTD_sel && Flag_NTD == false) {
      ...
      for (int ip = 0; ip < ip_NTD; ip++) {
        ...
        Double_t DT1, DT2;
        h1_NTD_1_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
	  ...
	  if (abs(T_NTD[ip] - T_COV1[jp]) <= 50.) {
            ...
            h2_DeltaT_NTD_COV1_P_NTD->Fill(log10((P_NTD[ip]-OffNTD)/CalNTD/1000.),T_NTD[ip] - T_COV1[jp]);
          } 
          if ((T_NTD[ip] - T_COV1[jp]) >= -2. && (T_NTD[ip] - T_COV1[jp]) < 3.) {
            Flag_COV1 = true;
            h1_P_COV1->Fill(P_COV1[jp]/1000.);
            h1_NTD_21_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
          }
          if ((T_NTD[ip] - T_COV1[jp] - DTacc) >= -2. && (T_NTD[ip] - T_COV1[jp] - DTacc) < 3.) {
            Flag_noCOV1 = true;
            Flag_noCOV1_M = true;
            h1_P_noCOV1->Fill(P_COV1[jp]/1000.);
            h1_P_noCOV1_DTacc->Fill(P_COV1[jp]/1000.);
            h1_NTD_22_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
           }
          ...
          if ((T_NTD[ip] - T_COV1[jp] + DTacc) >= -2. && (T_NTD[ip] - T_COV1[jp] + DTacc) < 3.) {
            ...
            h1_P_noCOV1->Fill(P_COV1[jp]/1000.);
            h1_P_noCOV1_DTacc->Fill(P_COV1[jp]/1000.);
            h1_NTD_23_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
          }
	  ...
	  if (abs(T_NTD[ip] - T_COV2[jp]) <= 50.) {
            ...
            h2_DeltaT_NTD_COV2_P_NTD->Fill(log10((P_NTD[ip]-OffNTD)/CalNTD/1000.),T_NTD[ip] - T_COV2[jp]);
          } 
          if ((T_NTD[ip] - T_COV2[jp]) >= -2. && (T_NTD[ip] - T_COV2[jp]) < 3.) {
            Flag_COV2 = true;
            h1_P_COV2->Fill(P_COV2[jp]/1000.);
            h1_NTD_24_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
          }
	  if ((T_NTD[ip] - T_COV2[jp] - DTacc) >= -2. && (T_NTD[ip] - T_COV2[jp] - DTacc) < 3.) {
            Flag_noCOV2 = true;
            Flag_noCOV2_M = true;
            h1_P_noCOV2->Fill(P_COV2[jp]/1000.);
            h1_P_noCOV2_DTacc->Fill(P_COV2[jp]/1000.);
            h1_NTD_25_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
          }
	  ...
	  if ((T_NTD[ip] - T_COV2[jp] + DTacc) >= -2. && (T_NTD[ip] - T_COV2[jp] + DTacc) < 3.) {
            ...
            h1_P_noCOV2->Fill(P_COV2[jp]/1000.);
            h1_P_noCOV2_DTacc->Fill(P_COV2[jp]/1000.);
            h1_NTD_26_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
          }	 
        }
        ...
        h2_E_NTD_DeltaT_Closest->Fill((P_NTD[ip]-OffNTD)/CalNTD,T_Closest);
        Int_t ie = int(2.*log((P_NTD[ip]-OffNTD)/CalNTD));
        if (ie < 20) {
          h1_DeltaT_Closest_E[ie]->Fill(T_Closest);
          h1_IE[ie]->Fill(log((P_NTD[ip]-OffNTD)/CalNTD));
        }
          
        if (T_Closest >=  -2. && T_Closest <   3.) h1_NTD_11_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (T_Closest <   -4. || T_Closest >=  5.) h1_NTD_12_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (T_Closest >=  -9. && T_Closest <  -5.) h1_NTD_13_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (T_Closest >=   5. && T_Closest <   9.) h1_NTD_13_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);

        if (Flag_COV1 == false && Flag_COV2 == false) h1_NTD_2_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if ((Flag_noCOV1_M && !Flag_COV2) || (Flag_noCOV2_M && !Flag_COV1)) h1_NTD_2_MeV_DTacc->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if ((Flag_noCOV1_P && !Flag_COV2) || (Flag_noCOV2_P && !Flag_COV1)) h1_NTD_2_MeV_DTacc->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV1 == true) h1_NTD_3_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV2 == true) h1_NTD_4_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV1 == true && Flag_COV2 == false) h1_NTD_7_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV2 == true && Flag_COV1 == false) h1_NTD_8_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
	  ...
	  if (T_NTD[ip] - T_COV1[jp1] - DTacc/2. >= -2. && T_NTD[ip] - T_COV1[jp1] - DTacc/2. < 4.) { 
            for (int jp2 = 0; jp2 < ip_COV2; jp2++) {
              if (T_NTD[ip] - T_COV2[jp2] - DTacc/2. >= -2. && T_NTD[ip] - T_COV2[jp2] - DTacc/2. < 4.) {
                ...
                h1_NTD_27_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
              }
              if (T_NTD[ip] - T_COV2[jp2] + DTacc/2. >= -2. && T_NTD[ip] - T_COV2[jp2] + DTacc/2. < 4.) {
                Flag_noCOV1andCOV2_12 = true;
                h1_NTD_28_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
              }
            }
          }
	  if (T_NTD[ip] - T_COV1[jp1] + DTacc/2. >= -2. && T_NTD[ip] - T_COV1[jp1] + DTacc/2. < 4.) { 
...
//
        if (Flag_noCOV1andCOV2_11 || Flag_noCOV1andCOV2_12 || Flag_noCOV1andCOV2_21 || Flag_noCOV1andCOV2_22 ) h1_NTD_5_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV1andCOV2_11 == true) h1_NTD_9_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV1andCOV2_22 == true) h1_NTD_9_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV1andCOV2_12 == true) h1_NTD_10_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
        if (Flag_noCOV1andCOV2_21 == true) h1_NTD_10_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
//
        for (int jp1 = 0; jp1 < ip_COV1; jp1++) {
	  if ((T_NTD[ip] - T_COV1[jp1]) >= -2. && (T_NTD[ip] - T_COV1[jp1]) < 4.) { 
        ...
        if (Flag_COV1andCOV2 == true) h1_NTD_6_MeV->Fill((P_NTD[ip]-OffNTD)/CalNTD/1000.);
//
      }
      iw_NTD++; 
    }
