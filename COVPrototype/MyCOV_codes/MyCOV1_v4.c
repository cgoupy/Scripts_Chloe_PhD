...
/////////////////////////////////////////////////////////////////////////////
  ...
  char myfile_name[ ] = "2021_04_29_09_54_36.root";
...
/////////////////////////////////////////////////////////////////////////////
  ...
  float T_COV1[10000], T_COV2[10000], T_NTD[10000], T_COV1and2[10000];
...
// Read Ge detector data
  ...
  ifstream rf1("/sps/lbno/edoardo/Actuator/2021/Logged Data_2021_05_05_17_40_40.Bin1", ios::in | ios::binary);
  if (!rf1) {cout << "Cannot open input file 1!" << endl;}

  ifstream rf2("/sps/lbno/edoardo/Actuator/2021/Logged Data_2021_05_05_17_40_40.Bin2", ios::in | ios::binary);
  if (!rf2) {cout << "Cannot open input file 2!" << endl;}

  ifstream rf3("/sps/lbno/edoardo/Actuator/2021/Logged Data_2021_05_05_17_40_40.Bin3", ios::in | ios::binary);
  if (!rf3) {cout << "Cannot open input file 3!" << endl;}

  ifstream rf4("/sps/lbno/edoardo/Actuator/2021/Logged Data_2021_05_05_17_40_40.Bin4", ios::in | ios::binary);
  if (!rf4) {cout << "Cannot open input file 4!" << endl;}

  ifstream rf5("/sps/lbno/edoardo/Actuator/2021/Logged Data_2021_05_05_17_40_40.NTD", ios::in | ios::binary);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  Double_t Threshold_keV_1 = 10.0;
  Double_t Threshold_keV_2 = 10.0;
  Double_t Peak1_Threshold = 10.0; 
  Double_t Peak2_Threshold = 10.0; 
  Double_t Peak1_Upper_Threshold = 15.0; 
  ...
  //while (!rf1.eof() && !rf2.eof() && !rf3.eof() && !rf4.eof() && !rf5.eof() && nw1 < 5000*NS) {
...
//
	  ...
	  if (abs(T_NTD[ip] - T_COV1[jp1]) <= 50.) { 
            for (int jp2 = 0; jp2 < ip_COV2; jp2++) {
	      if (abs(T_NTD[ip] - T_COV2[jp2]) <= 50.) { 
                h2_NTD_T1_T2->Fill(T_NTD[ip] - T_COV1[jp1],T_NTD[ip] - T_COV2[jp2]); 
              }
            }
          }
        }
	  ...
	  if (abs(T_NTD[ip] - T_COV1and2[jp]) <= 50.) {
...
//
	  ...
	  if ((T_NTD[ip] - T_COV1[jp1] - DTacc/2.) >= -2. && (T_NTD[ip] - T_COV1[jp1] - DTacc/2.) < 4.) { 
            for (int jp2 = 0; jp2 < ip_COV2; jp2++) {
              if ((T_NTD[ip] - T_COV2[jp2] - DTacc/2.) >= -2. && (T_NTD[ip] - T_COV2[jp2] - DTacc/2.) < 4.) Flag_noCOV1andCOV2_11 = true;
              if ((T_NTD[ip] - T_COV2[jp2] + DTacc/2.) >= -2. && (T_NTD[ip] - T_COV2[jp2] + DTacc/2.) < 4.) Flag_noCOV1andCOV2_12 = true;
            }
          }
	  if ((T_NTD[ip] - T_COV1[jp1] + DTacc/2.) >= -2. && (T_NTD[ip] - T_COV1[jp1] + DTacc/2.) < 4.) { 
            for (int jp2 = 0; jp2 < ip_COV2; jp2++) {
              if ((T_NTD[ip] - T_COV2[jp2] - DTacc/2.) >= -2. && (T_NTD[ip] - T_COV2[jp2] - DTacc/2.) < 4.) Flag_noCOV1andCOV2_21 = true;
              if ((T_NTD[ip] - T_COV2[jp2] + DTacc/2.) >= -2. && (T_NTD[ip] - T_COV2[jp2] + DTacc/2.) < 4.) Flag_noCOV1andCOV2_22 = true;
            }
          }	
        }
//
